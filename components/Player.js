...
function Player({ accessToken, trackUri}) {
 ...
 if (!accessToken) return null;
  ...
  return   <div className="bg-[#181818] flex items-center justify-between px-5 py-2.5 rounded-t-2xl relative space-x-20 md:space-x-0 overflow-x-scroll md:overflow-x-hidden scrollbar-hide">
